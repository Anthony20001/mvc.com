        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10" data-aos="fade-up">
                    ...
                    <p class="sub-heading mb-5">Diseña, crea y vende tus platillos favoritos. <a href="#"><strong>Registrate</strong></a></p>
                    <p><a href="#" class="smoothscroll btn btn-outline-white px-5 py-3">Inicia sesión</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row section-heading justify-content-center mb-5">
            <div class="col-md-8 text-center">
                ...
                <p class="sub-heading mb-5">Provee de una gran variedad de categorias para tus clientes. <a href="#">Registrate</a></p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row section-heading justify-content-center mb-5">
            <div class="col-md-8 text-center">
                ...
                <p class="sub-heading mb-5">Administra, modifica y visualiza tus creaciones. <a href="#">Registrate</a></p>
            </div>
        </div>
        <div class="row">
